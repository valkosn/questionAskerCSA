...
<form id="question_form_template" class="question_form" style="display: none">
  ...
  <select id="category_template" name="category" title="Category">
    <c:forEach items="${categories}" var="cat">
      <option id="category_${cat.key}" value="${cat.key}">${cat.value}</option>
    </c:forEach>
  </select> <br/>
  <input id="question_template" class="control_container_element" name="question" type="text" value="Question" title="Question"/> <br/>
